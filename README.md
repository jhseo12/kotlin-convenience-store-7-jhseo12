...
### Model
- [x] 재고 목록 불러오는 기능
- [x] 구매할 상품 및 수량에 대한 오류 검사 (잘못된 입력, 존재하지 않는 상품, 재고 불충분)
- [x] 프로모션 할인 기능
  - [x] 해당되는 상품이 있을 때, 해당 수량보다 고객이 적게 가져왔는지 확인
    - 적게 가져왔을 때
      - [x] 추가 여부가 Y일 경우, 해당 수량만큼 상품 추가
      - [x] 추가 여부가 N일 경우, 상품을 추가하지 않는다.
    - 프로모션 재고가 부족할 때
      - [x] 정가 결제 여부가 Y일 경우, 해당 수량만큼 정가 결제
      - [x] 정가 결제 여부가 N일 경우, 해당 수량만큼 상품 제외
- [x] 멤버십 할인 기능
- [x] 재고 업데이트 기능
...
- [x] 프로모션 적용 상품에 대해 고객이 해당 수량보다 적게 가져온 경우 추가 여부 입력받는 기능
- [x] 프로모션 재고가 부족해 일부 수량을 정가로 결제할지, 해당 수량만큼 제외하고 결제할지 여부를 입력받는 기능
...
### Controller
- [x] 모델로부터 재고를 받아와 뷰에게 출력 요청
- [x] 뷰로부터 구매할 상품명과 수량을 받아와 모델에게 전처리 요청(예외 처리 검사 등)
- [x] 모델에게 프로모션 할인 처리 요청
- [x] 모델에게 멤버십 할인 처리 요청
- [x] 뷰에게 영수증 출력 요청
